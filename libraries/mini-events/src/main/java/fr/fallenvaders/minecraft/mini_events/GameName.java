...
public enum GameName {
  ...
  public GameMode getGamemode() {
    if (this.gamemode == 0) return GameMode.SURVIVAL;
    else if (this.gamemode == 1) return GameMode.CREATIVE;
    else if (this.gamemode == 2) return GameMode.ADVENTURE;
    else if (this.gamemode == 3) return GameMode.SPECTATOR;
    else return null;
  }
