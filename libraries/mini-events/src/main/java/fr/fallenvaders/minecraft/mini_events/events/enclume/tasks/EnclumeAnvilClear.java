...
public class EnclumeAnvilClear extends BukkitRunnable {
  ...
  public EnclumeAnvilClear(
      int lowestPointX, int lowestPointZ, int highestPointX, int highestPointZ, int groundY) {
  ...
  public static void ClearParameters(int groundY) {
    ...
    EnclumeAnvilClear start =
        new EnclumeAnvilClear(lowestPointX, lowestPointZ, highestPointX, highestPointZ, groundY);
