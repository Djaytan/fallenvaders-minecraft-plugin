...
public abstract class InventoryBuilder implements InventoryProvider {
  ...
  protected Builder getBuilder() {
    Builder res = SmartInventory.builder().manager(MailBox.getManager());
  ...
  public ClickableItem nextPageItem(Player player, InventoryContents contents) {
    ...
    return ClickableItem.of(
        new ItemStackBuilder(Material.ARROW)
            .setName(String.format("%s%s" + NEXT_PAGE, ChatColor.YELLOW, ChatColor.BOLD))
            .build(),
  ...
  public ClickableItem previousPageItem(Player player, InventoryContents contents) {
    ...
    return ClickableItem.of(
        new ItemStackBuilder(Material.ARROW)
            .setName(String.format("%s%s" + PREVIOUS_PAGE, ChatColor.YELLOW, ChatColor.BOLD))
            .build(),
  ...
  public ClickableItem goBackItem(Player player) {
    ...
    return ClickableItem.of(
        new ItemStackBuilder(Material.OAK_SIGN).setName(name).build(),
