    ...
    contents.set(
        ...
        ClickableItem.of(
            new ItemStackBuilder(Material.BOOKSHELF)
                .setName(String.format("%s%s" + LETTERS, ChatColor.WHITE, ChatColor.BOLD))
                .build(),
            (e) -> {
    ...
    contents.set(
        ...
        ClickableItem.of(
            new ItemStackBuilder(Material.CHEST)
                .setName(String.format("%s%s" + ITEMS, ChatColor.WHITE, ChatColor.BOLD))
                .build(),
            (e) -> {
              if (e.getClick() == ClickType.LEFT) {
      ...
      contents.set(
          ...
          ClickableItem.of(
              new ItemStackBuilder(Material.HOPPER)
                  .setName(String.format("%s%s" + CREATION, ChatColor.WHITE, ChatColor.BOLD))
                  .build(),
              (e) -> {
                if (e.getClick() == ClickType.LEFT) {
