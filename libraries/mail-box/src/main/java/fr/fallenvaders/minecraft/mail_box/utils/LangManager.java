...
public class LangManager {
    ...
    public static void load() {
        ...
        if (cfg != null) {
            ...
            MailBox.main.getLogger().log(Level.SEVERE, "Can't load the lang file \"" + fileName + "\". The default lang file will be used.");
        }
    ...
    private static void saveDefaultLangFile() {
        ...
        if (!file.exists()) {
            try {
                ...
                MailBox.main.getLogger().log(Level.SEVERE, "Could not create config to " + file.getName() + " to " + file.getPath());
                e.printStackTrace();
            }
