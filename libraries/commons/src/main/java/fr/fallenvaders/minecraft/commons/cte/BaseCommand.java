 ...
 * <br>
 * <b>Commande à ne pas créer : </b><i>/&lt;label&gt; help</i> (créée par défaut)
 *
 * @author Voltariuss
 * @version 1.5.0
 */
public abstract class BaseCommand implements CommandExecutor {
  ...
  /**
   * Vérifie si le joueur possède la permission globale d'exécution de la commande puis tente de
   * l'exécuter en parcourant son arbre d'exécution.
   *
