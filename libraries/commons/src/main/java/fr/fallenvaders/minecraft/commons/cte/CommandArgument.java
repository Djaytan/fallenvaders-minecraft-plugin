...
public class CommandArgument {
   ...
   *
   * @param type Le type d'argument, non null
   * @param isRequired True si l'argument est requis dans l'exécution de la commande, false sinon
   */
   ...
   * @param alias La liste des aliases de l'argument, non null
   */
  ...
  /** @return True si l'argument est requis dans l'exécution de la commande, false sinon */
