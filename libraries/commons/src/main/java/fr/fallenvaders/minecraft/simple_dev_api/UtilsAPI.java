package fr.fallenvaders.minecraft.simple_dev_api;
...
public class UtilsAPI {
  ...
  // SQL
  public static final String SQL_CONNECTION_ATTEMPT =
      "§eTentative de connexion à la base de données...";
  public static final String SQL_CONNECTION_FAILED = "Connexion impossible à la base de données !";
  public static final String SQL_NO_CONNECTION =
      "Le plugin n'est connecté à aucune base de données. Certaines fonctionnalités ont été bridées ou désactivées.";
  ...
  public static final String COMMAND_HELP_CHANGE_PAGE =
      "§cPour changer de page : §6/%s help §b[page]";
  ...
  // Serveur
  public static final String CONNECTION_BLOCKED =
      "Connexion au serveur interrompue : une erreur interne est survenue. Veuillez réessayer."
  ...
  public static final String INTERNAL_EXCEPTION =
      "Une erreur interne est survenue. S'il vous plait, veuillez contacter un administrateur ou un développeur dans les plus brefs délais.";
  // Joueur
  ...
  public static final String PLAYER_NOT_FOUND =
      "Le joueur est introuvable (déconnecté ou inexistant).";
  ...
  public static final String NUMBER_MUST_BE_GREATER_THAN =
      "Le nombre spécifié doit être strictement supérieur à %s.";
  public static final String NUMBER_MUST_BE_GREATER_OR_EQUAL_THAN =
      "Le nombre spécifié doit être supérieur ou égal à %s.";
  public static final String NUMBER_MUST_BE_LESS_THAN =
      "Le nombre spécifié doit être strictement inférieur à %s.";
  public static final String NUMBER_MUST_BE_LESS_OR_EQUAL_THAN =
      "Le nombre spécifié doit être inférieur ou égal à %s.";
  ...
  public static final String NUMBER_MUST_BE_STRICTLY_NEGATIVE =
      "Le nombre spécifié doit être strictement négatif.";
  public static final String NUMBER_MUST_BE_STRICTLY_POSITIVE =
      "Le nombre spécifié doit être strictement positif.";
  public static final String NUMBER_MUST_IN_INTERVAL =
      "Le nombre spécifié doit être compris entre %s et %s.";
  // Inventaire
  ...
  public static final String INVENTORY_NOT_ALLOWED_ITEM =
      "Cet item ne peut être placé dans cet inventaire.";
  // Commands
  ...
  public static final String COMMAND_INPUT_ARGUMENT_WRONG =
      "Un des arguments saisis est incorrect.";
  ...
  public static final String COMMAND_CONSISTENCY_ARGUMENTS_EXCEPTION =
      "Un argument optionnel ne peut précéder un argument obligatoire";
  // Others
  public static final String CONSOLE_NAME = "CONSOLE";
  public static final String PERMISSION_MISSING = "Vous n'avez pas la permission nécessaire.";

  /**
   * @param pluginClass La classe principale du plugin correspondant, non null
   * @return Le préfixe du plugin correspondant, non null
   */
  public static String getPluginPrefix(Class<?> pluginClass) {
    return String.format(
        "§4[§c%s§4] ", pluginClass.getSimpleName().replace("Dornacraft", "Dornacraft-"));
  }

  /**
   * Envoie un message d'activation ou de désactivation du plugin spécifié.
   *
   * @param pluginClass La classe du plugin concerné, non null
   * @param isEnabled True si le plugin est activé, false sinon
   */
  public static void sendActivationMessage(Class<?> pluginClass, boolean isEnabled) {
    ...
    Bukkit.getLogger()
        .fine(
            String.format(
                "%s§e~ §bPlugin §6%s %s", getPluginPrefix(pluginClass), pluginName, state));
  }

  /**
   * Envoie un message à la cible spécifiée. Remplace toutes les suites de caractères "§r"
   * (ChatColor.RESET) par la couleur du message associé au niveau de message spécifié.
   *
   * @param messageLevel Le niveau du message, non null
   * @param target Le destinataire, non null
   * @param message Le message à envoyer, non null
   * @param args La liste des arguments du message, optionnel
   */
  public static void sendSystemMessage(
      MessageLevel messageLevel, CommandSender target, String message, Object... args) {
    target.sendMessage(
        String.format(
            messageLevel.getPrefix()
                + message.replaceAll(
                    ChatColor.RESET.toString(), messageLevel.getMsgColor().toString()),
            args));
  }
}
