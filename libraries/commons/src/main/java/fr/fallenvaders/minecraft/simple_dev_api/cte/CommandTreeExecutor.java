...
public class CommandTreeExecutor {
     ...
     * {@link CommandNode#CommandNode(CommandArgument, String, CommandNodeExecutor, String)}</i></li>
     * </ul>
     *
     * @param cmds La liste des noueuds à ajouter dans l'arbre d'exécution de la
     *             commande, non null
     */
     ...
     *
     * @param args La liste des arguments de la commande saisis par l'émetteur,
     *             non null
