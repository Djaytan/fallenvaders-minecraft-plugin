...
public class CommandArgumentType {
  ...
  /**
   * Définit le type d'argument attendu à une chaîne de caractère. En d'autres terme, toute saisie
   * est acceptée (type d'argument par défaut à utiliser donc).
   */
  public static final CommandArgumentType STRING = new CommandArgumentType("saisie", arg -> {});

  /** Définit le type d'argument à un nombre. */
  public static final CommandArgumentType NUMBER =
      new CommandArgumentType("nombre", Integer::parseInt);

  /** Définit le type d'argument à un joueur connecté. */
  public static final CommandArgumentType ONLINE_PLAYER =
   ...
   * Constructeur
   *
   * @param label Le label de l'argument, non null
   * @param checker Le vérificateur d'argument, peut être null
   */
  ...
  /**
   * Créer et retourne le type d'argument avec un label différent (utile pour modifier le label d'un
   * attribut statique tel que STRING par exemple)
   *
   * @param label Le nouveau label de l'argument, non null
   ...
   *
   * @param checker Le vérificateur de l'argument, peut être null
   */
