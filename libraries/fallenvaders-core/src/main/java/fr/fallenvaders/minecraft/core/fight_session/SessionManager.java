...
public class SessionManager {
  ...
  /**
   * Sauvegarde en mémoire une session pour utilisation ultérieure <br>
   * <strong>/!\ Cet action écrase l'ancienne session si existante /!\</strong>
   *
  ...
  /**
   * Supprime de la mémoire la session cible <br>
   * ne fait rien si inexistante
   *
  ...
  /**
   * Supprime le joueur propriétaire de la session en tant que cible (Utilisé lorsqu'un joueur se
   * fait tuer par son opposant)
   *
