...
public class LangManager extends ConfigController {
  private static String FOLDER_PATH =
      FallenVadersCore.main.getDataFolder() + File.separator + "lang";
  private static String CFG_NAME =
      FallenVadersCore.main.getConfig().getString("lang_file") + ".yml";
  private static String DEFAULT_RESSOURCE =
      FallenVadersCore.main.getConfig().getString("lang_file") + ".yml";
  ...
  public static LangManager loadDefaults() {
    ...
    LangManager defaultLangManager =
        new LangManager(
            FallenVadersCore.main.getDataFolder() + File.separator + "lang",
            FallenVadersCore.main.getConfig().getString("lang_file") + ".yml",
            FallenVadersCore.main.getConfig().getString("lang_file") + ".yml");
  ...
  protected void onLoad() {
    if (configuration != null) {
      FallenVadersCore.main.getLogger().log(Level.INFO, "Lang file \"" + CFG_NAME + "\" loaded.");
  ...
  @Override
  public void load() {
    FOLDER_PATH = FallenVadersCore.main.getDataFolder() + File.separator + "lang";
    CFG_NAME = FallenVadersCore.main.getConfig().getString("lang_file") + ".yml";
    DEFAULT_RESSOURCE = FallenVadersCore.main.getConfig().getString("lang_file") + ".yml";
