...
public class SanctionsAlgo {
  ...
  public static void generateSanction(Sanction sanction, Player moderator, Player target) {
    ...
    final String CFG_PATH_POINT = "justicehands.sanctionmanager.points-system";
    final int CFG_PATH_MUTE_MIN_POINT = CONFIG.getInt(CFG_PATH_POINT + ".mute-min-points");
    final int CFG_PATH_BAN_DAY_POINT = CONFIG.getInt(CFG_PATH_POINT + ".ban-day-points");
    final int CFG_RISINGBAN_LIMIT = CONFIG.getInt(CFG_PATH_POINT + ".risingban-points");
  ...
  private static void generateBanMute(
    ...
    final long LONG_MIN = 60l * 1000l; // sec(60) * ms(1000)
    final long LONG_DAY = 24l * 60l * 60l * 1000l; // hour(24) * min(60) * sec(60) * ms(1000)
