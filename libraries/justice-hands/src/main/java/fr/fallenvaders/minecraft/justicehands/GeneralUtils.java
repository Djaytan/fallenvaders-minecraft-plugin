...
public class GeneralUtils {
  private static final String CRPrefix = "§7[§6CriminalRecords§7] §r";
  private static final String MTPrefix = "§7[§cModeratorTools§7] §r";
  private static final String SMPrefix = "§7[§9SanctionManager§7] §r";
  private static final String KKPrefix = "§7[§4KeysKeeper§7] §r";
  ...
  public static ItemStack emptyCR() {
    ...
    meta.setLore(
        Arrays.asList(" ", "§7Le casier judiciaire du joueur", "§7est vide, aucune sanction."));
    item.setItemMeta(meta);
    return item;
  }
