...
public class CommandNode {
     ...
     * @param specificPermission La permission spécifique applicable à ce noeud uniquement,
     *                           peut être null
     */
    CommandNode(CommandNode parent, CommandArgument argument, String description, CommandNodeExecutor executor,
     ...
     *                           peut être null
     */
    public CommandNode(CommandArgument argument, String description, CommandNodeExecutor executor,
                       String specificPermission) {
     ...
     *
     * @param label           Le label de la commande, non null
     * @param withDescription Indique si le message d'utilisation de la commande doit être
