package fr.fallenvaders.minecraft.core.mail_box.inventory.builders;
...
public abstract class InventoryBuilder implements InventoryProvider {
    ...
    protected Builder getBuilder() {
        Builder res = SmartInventory.builder().manager(FallenVadersCorePlugin.getManager());
    ...
    public void openInventory(Player player) {
        Bukkit.getScheduler().runTask(FallenVadersCorePlugin.main, () -> {
