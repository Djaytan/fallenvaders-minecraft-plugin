package fr.fallenvaders.minecraft.core.mail_box.data_manager;

import fr.fallenvaders.minecraft.core.mail_box.sql.ItemDataSQL;
import fr.fallenvaders.minecraft.core.mail_box.sql.LetterDataSQL;
...
public class MailBoxController {
	...
	public static void readLetter(Player player, LetterData letterData) {
		// player.openBook(getBookView(letterData)); TODO corriger
