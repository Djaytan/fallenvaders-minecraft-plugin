...
import fr.fallenvaders.minecraft.core.mail_box.inventory.inventories.PlayerSelectionInventory;
...
import fr.fallenvaders.minecraft.core.mail_box.listeners.utils.hookers.CH_Duration;
import fr.fallenvaders.minecraft.core.mail_box.listeners.utils.hookers.CH_LetterContent;
import fr.fallenvaders.minecraft.core.mail_box.listeners.utils.hookers.CH_LetterObject;
import fr.fallenvaders.minecraft.core.mail_box.listeners.utils.hookers.CH_Player;
            ...
            e -> {
                ...
                if (click == ClickType.LEFT || click == ClickType.RIGHT) {
                    ...
                    if (msgSize < 200) { //max length of objet
                        //set content
                        player.closeInventory();
                        CH_LetterObject ch = new CH_LetterObject(CH_MESSAGE_START, this.getObject(), this);
                        ch.start(player);
                ...
                if (click == ClickType.LEFT || click == ClickType.RIGHT) {
                    ...
                    if (msgSize < 700) {
                        if (click == ClickType.LEFT) {
                            ...
                            if (chCheck == null) {
                                player.closeInventory();
                                CH_LetterContent ch = new CH_LetterContent(CH_MESSAGE_START, this.getMessage(), this, false);
                                ch.start(player);
